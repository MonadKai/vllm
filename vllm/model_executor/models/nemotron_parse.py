...
from vllm.model_executor.models.bart import BartParallelLMHead, BartScaledWordEmbedding, MBartDecoderLayer
    ...
    def preprocess(
        ...
        **kwargs,
        ...
        for image in processed_images:
            try:
                # Manual resize with aspect ratio preservation (replaces LongestMaxSizeHW)
...
class NemotronParseProcessor:
    ...
    def __call__(
        ...
        **kwargs):
        ...
        combined_outputs = {**BatchEncoding(text_inputs, tensor_type=return_tensors), **image_inputs}
...
class NemotronParseForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def get_input_embeddings(
        ...
        # For vLLM encoder-decoder models, flatten embeddings to [total_tokens, hidden_dim]
