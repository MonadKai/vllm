...
Parrot2AudioMoeInputs: TypeAlias = Parrot2AudioMoeFeatureInputs | Parrot2AudioMoeEmbeddingInputs
...
class Parrot2AudioMoeForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def _parse_and_validate_audio_input(
        ...
        if audio_embeds is not None:
            return Parrot2AudioMoeEmbeddingInputs(type="audio_embeds", audio_embeds=audio_embeds)

        if input_features is not None:
            return Parrot2AudioMoeFeatureInputs(type="audio_features", input_features=input_features, feature_attention_mask=feature_attention_mask)
