...
from vllm.audio_parsers import AudioParser, AudioParserManager
            ...
            async for res in result_generator:
                if res.prompt_token_ids is not None:
                    ...
                    if self.enable_step_audio_2_tts_ta4_parser:
                        ...
                        # if is_tts_ta4_output:
                        #     need_byte_fall_back_token_ids = res.prompt_token_ids
                ...
                for output in res.outputs:
                    ...
                    if tool_choice_auto or self.reasoning_parser or self.enable_step_audio_2_tts_ta4_parser:
