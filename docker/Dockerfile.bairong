...
COPY dist/transformers-4.53.1.tar.gz /tmp/transformers-4.53.1.tar.gz
RUN pip uninstall transformers -y && pip install /tmp/transformers-4.53.1.tar.gz --no-deps && rm -rf /tmp/transformers-4.53.1.tar.gz
