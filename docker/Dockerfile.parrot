...
# COPY dist/vllm_tei_plugin-0.10.2.tar.gz /tmp/vllm_tei_plugin-0.10.2.tar.gz
# RUN pip install /tmp/vllm_tei_plugin-0.10.2.tar.gz --no-deps && rm -rf /tmp/vllm_tei_plugin-0.10.2.tar.gz
