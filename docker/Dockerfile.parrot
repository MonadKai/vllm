FROM docker.m.daocloud.io/vllm/vllm-openai:v0.10.1

# add vllm tei plugin support
# COPY dist/vllm_tei_plugin-0.10.1.tar.gz /tmp/vllm_tei_plugin-0.10.1.tar.gz
# RUN pip install /tmp/vllm_tei_plugin-0.10.1.tar.gz --no-deps && rm -rf /tmp/vllm_tei_plugin-0.10.1.tar.gz
