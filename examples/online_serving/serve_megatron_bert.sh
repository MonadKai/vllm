MODEL_PATH="/path/to/huggingface/Fengshenbang/Erlangshen-MegatronBert-1.3B-Chinese"
...
vllm serve $MODEL_PATH --hf-overrides "{\"architectures\": [\"MegatronBertModel\"]}" --served-model-name $SERVED_MODEL_NAME
